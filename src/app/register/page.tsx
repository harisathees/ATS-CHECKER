...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900/20 via-[#0a0a0a] to-[#0a0a0a]">
            {/* Ambient glows */}
            <div className="absolute top-[20%] right-[20%] w-[30vw] h-[30vw] rounded-full bg-violet-600/10 blur-[100px] pointer-events-none animate-float-slow" />
            <div className="absolute bottom-[20%] left-[20%] w-[30vw] h-[30vw] rounded-full bg-fuchsia-600/10 blur-[100px] pointer-events-none animate-float-delay" />
            ...
            <div className="w-full max-w-md bg-white/[0.02] backdrop-blur-xl border border-white/5 p-8 rounded-3xl shadow-2xl z-10">
                <div className="flex flex-col items-center mb-10">
                    ...
                    <p className="text-sm text-gray-400">Join ATS Checkerligence today</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-4 mb-6">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full flex items-center justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500 focus:ring-offset-gray-900 transition-all disabled:opacity-50 mt-2"
                    >
                ...
                <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-[#0a0a0a] text-gray-500">Or sign up with</span>
                    </div>
                </div>
                ...
                <p className="mt-8 text-center text-sm text-gray-400">
                    ...
                    <Link href="/login" className="font-medium text-violet-400 hover:text-violet-300 gap-1 inline-flex items-center transition-colors">
